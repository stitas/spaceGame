...
player_ship = pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\starship.png')
asteroid_img = pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\asteroid.png')
laser_blue = pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\projectileblue.png')
bg = pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\space.png')

explosions = [pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion00.png'),pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion01.png'),
              pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion02.png'),pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion03.png'),
              pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion04.png'),pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion05.png'),
              pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion06.png'),pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion07.png'),
              pygame.image.load(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\regularExplosion08.png')]

pygame.font.init()
font_small = pygame.font.Font(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\font.ttf',15)
font_big = pygame.font.Font(r'C:\Users\Titas\Desktop\python\spacegame\venv\assets\font.ttf',40)
...
class Laser(pygame.sprite.Sprite):
    def __init__(self,x,y,image):
        ...
        self.vel_laser = 0
        self.image = image
        self.rect = pygame.Rect(self.image.get_rect().left,self.image.get_rect().top,self.image.get_rect().width,self.image.get_rect().height-10)
    ...
    def update(self, *args, **kwargs) -> None:
        ...
        if self.keys[pygame.K_UP] and self.vel_laser == 0 and self.rect.center[1] != 51:
            self.y -= self.vel
        if self.keys[pygame.K_DOWN] and self.vel_laser == 0 and self.rect.center[1] != 966:
            self.y += self.vel
        if self.keys[pygame.K_LEFT] and self.vel_laser == 0 and self.rect.center[0] != 46:
            self.x -= self.vel
        if self.keys[pygame.K_RIGHT] and self.vel_laser == 0 and self.rect.center[0] != 976:
            self.x += self.vel
        if self.keys[pygame.K_LCTRL]:
            self.vel_laser = 20
        self.y -= self.vel_laser
        if self.y < 0:
            self.vel_laser = 0
            if ship_pos[0][0] < ship_pos[1][0]:
                self.x = ship_pos[0][0] + 28
            elif ship_pos[0][0] > ship_pos[1][0]:
                self.x = ship_pos[0][0] - 28
            elif ship_pos[0][0] == ship_pos[1][0]:
                self.x = ship_pos[0][0]
            elif ship_pos[0][0] == ship_pos[1][0]:
...
laser = Laser(526,726,laser_blue)
